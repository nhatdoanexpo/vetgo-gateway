...
import vn.vetgo.gateway.repository.CategoryRepository;
import vn.vetgo.gateway.service.dto.CategoryDTO;
import vn.vetgo.gateway.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    private static final Long DEFAULT_ID_PARENT = 1L;
    private static final Long UPDATED_ID_PARENT = 2L;
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getId_parent()).isEqualTo(DEFAULT_ID_PARENT);
    ...
    void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.[*].id_parent").value(hasItem(DEFAULT_ID_PARENT.intValue())))
    ...
    void getCategory() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.id_parent").value(DEFAULT_ID_PARENT.intValue()))
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).id_parent(UPDATED_ID_PARENT).status(UPDATED_STATUS);
        ...
        assertThat(testCategory.getId_parent()).isEqualTo(UPDATED_ID_PARENT);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).id_parent(UPDATED_ID_PARENT).status(UPDATED_STATUS);
