...
import vn.vetgo.gateway.service.CategoryService;
import vn.vetgo.gateway.service.dto.CategoryDTO;
import vn.vetgo.gateway.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link vn.vetgo.gateway.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
    ...
    private static final String ENTITY_NAME = "vetgogatewayCategory";
